...
export default function Promotions() {
    return (
        <section className='max-w-7xl mx-auto mt-20 px-6'>
            ...
            <h3 className='text-center text-4xl font-bold my-4 text-white'>Our Promotion Events</h3>


            <div className='grid lg:grid-cols-4 gap-4'>
                <div className='sm:col-span-2 bg-[#d6d6d8] flex flex-col md:flex-row justify-center md:items-center h-auto lg:h-[200px] order-first text-black transition-transform duration-300 hover:scale-[1.03] cursor-pointer'>
                    <div className='ml-4'>
                ...
                <div className='sm:row-span-2 bg-[#efe1c7] h-auto text-black transition-transform duration-300 hover:scale-[1.03] cursor-pointer'>
                ...
                <div className='sm:row-span-2 bg-[#d7d7d9] h-auto order-last text-black transition-transform duration-300 hover:scale-[1.03] cursor-pointer'>
                ...
                <div className='sm:col-span-2 bg-[#212121] py-6 flex justify-center md:items-center h-auto lg:h-[200px] -order-2 lg:order-last border border-white/10 transition-transform duration-300 hover:scale-[1.03] cursor-pointer'>
                    <div>
                        ...
                        <h5 className='px-8 py-2 bg-[#474747] rounded-lg font-bold text-white font-[sans-serif] text-center spacing mt-2'>DINEWEEKENDSALE</h5>
                    </div>
                </div>
